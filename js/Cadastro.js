...
form.addEventListener('submit', function (e) {
    ...
    let inputEstCivil = form.input_EstadoCivil;
    ...
    let inputConfSenha = form.input_ConfSenha;
    ...
    if (inputEstCivil.value === "" || inputEstCivil.value === null) {
        inputEstCivil.classList.add('is-invalid');
        e.preventDefault();
    } else {
        inputEstCivil.classList.remove('is-invalid');
        inputEstCivil.classList.add('is-valid');
    }
    ...
    if (inputConfSenha.value === "" || inputConfSenha.value !== inputSenha.value) {
...
function ValidaNasc(dataNasc) {
    ...
    if (dia > 31 || mes > 12 || ano > (anoAtual - 16)) {
        return false;
    }
